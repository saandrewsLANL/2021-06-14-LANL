...
venue: "Los Alamos National Laboratory"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "online"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
language: "eb"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the
latitude: "35.881667"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-106.298333"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "June 14-17, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "10:00 - 14:30"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Stephen Andrews", "Patricia Grubel", "Jasper Thrussell"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Grant Meadors", "]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
